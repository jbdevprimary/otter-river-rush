...
import type { GameStatus, AnimationState } from '@otter-river-rush/types';
...
/** Default animation when idle (not currently used but reserved for future) */
export const DEFAULT_IDLE_ANIMATION: AnimationState = 'idle';
