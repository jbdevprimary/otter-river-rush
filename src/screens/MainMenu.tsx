  ...
  return (
    <View className="flex-1 bg-brand-background items-center justify-center p-6">
      ...
      <View className="items-center mb-8">
        <Text className="text-5xl font-bold text-brand-gold tracking-widest">OTTER</Text>
        <Text className="text-4xl font-semibold text-brand-secondary tracking-[8px] -mt-2">
          RIVER
        </Text>
        <Text className="text-6xl font-bold text-white tracking-[12px] -mt-2">RUSH</Text>
      </View>

      {/* High Score Display */}
      {progress.highScore > 0 && (
        <View className="items-center mb-8">
          <Text className="text-sm text-slate-400 tracking-widest">HIGH SCORE</Text>
      ...
      <View className="w-full max-w-[280px] mb-12">
        ...
        >
          <Text className="text-3xl font-bold text-white tracking-widest">PLAY</Text>
        </Pressable>
      ...
      <View className="flex-row justify-around w-full max-w-[320px] mb-8">
        <View className="items-center">
          <Text className="text-xl font-bold text-white">{progress.gamesPlayed}</Text>
        ...
        <View className="items-center">
          <Text className="text-xl font-bold text-white">{progress.totalCoins}</Text>
      ...
      <View className="absolute bottom-12 items-center">
        ...
        <Text className="text-sm text-slate-400 mt-1">Collect coins, avoid obstacles!</Text>
      </View>
    </View>
  );
}
